$(document).ready(function () {
  ...
  $(".navbar-toggler.border-0").on("click", function () {
    if (check_open == false) {
      ...
      $(".knlar1").each(function () { $(this).removeClass("d-none") })
      $(".knlar").each(function(){ $(this).addClass("d-none")})
      if ($(window).width() > 990) {
      ...
      check_open = false;
      $(".knlar1").each(function () { $(this).addClass("d-none") })
      $(".knlar").each(function(){ $(this).removeClass("d-none")})
      if ($(window).width() > 990) {
